...
Type: Tabular dataset containing customer demographics, purchase details, discounts, revenue, and product information
...
Built customer segmentation flags
...
Ran analytical SQL queries for:
...
Analyzed customer spending behavior across segments

Evaluated how discounts impact purchasing
...
3️⃣ Import dataset into MySQL (optional if using SQL part)
...
Real business analytics thinking

Hands-on SQL + Python + Power BI integration
